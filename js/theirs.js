$(document).ready(function () {
    ...
    $('#checkbox1').on('keyup', function (e) {

        var code = (e.keyCode ? e.keyCode : e.which);
        if (code == 13) {
            // $('#checkbox1').on('focus', function() {
    ...
    $('#checkbox1').on('focus', function () {
        ...
        $('.personA').css('box-shadow', '0px 0px 5px 5px rgba(0,0,255,1)')


    })

    $('#checkbox1').on('focusout', function () {

        $('.personA').css('box-shadow', 'none')

    })

    $('#checkbox2').on('focus', function () {

        $('.personB').css('box-shadow', '0px 0px 5px 5px rgba(0,0,255,1)')
    })

    $('#checkbox2').on('focusout', function () {

        $('.personB').css('box-shadow', 'none')
    ...
    $('.personA , .fullCircle').on('click', function () {
        if ($('input[name="selection"]').data('active') == 0) {
            $('.personA').data('active', 0);
            $('input[name="selection"]').data('active', 1);
            $('.personA').find('.blueBack.new').css('background', '#00467f');
            ...
            $('input[name="selection"]').data('active', 0);
    ...
    $('.questionBubble').on('click', function (e) {
        ...
        if ($('.questionBubble').hasClass('closeHelp')) {
            ...
            $('#checkbox1').attr('tabindex', '1')
            $('#checkbox2').attr('tabindex', '1')
